<?php
    ...
    $stmt1 = $pdo->prepare("SELECT * FROM user_table WHERE email = :user_email");
...
//        $val["id"] = "test";
        ...
        $sql = "INSERT INTO user_table(`name`,`user_nickname`,`email`) VALUES (:user_name,:user_name1,:user_email)";
//        $sql2 = "INSERT INTO user_table(`name`,`user_nickname`,`email`) VALUES ('".$_POST["user_name"]."','".$_POST["user_name"]."','".$_POST["user_name"]."')";
//        echo $sql2;
        $stmt2 = $pdo->prepare($sql);
        $stmt2->bindValue(':user_name',$_POST['user_name'],PDO::PARAM_STR);
        $stmt2->bindValue(':user_name1',$_POST['user_name'],PDO::PARAM_STR);
        $stmt2->bindValue(':user_email',$_POST['user_email'],PDO::PARAM_STR);
        $result2 = $stmt2->execute();
